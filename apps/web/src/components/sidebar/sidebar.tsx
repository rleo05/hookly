...
export function Sidebar(props: SidebarProps) {
  ...
  return (
    <>
      <aside
        className={`fixed md:static z-50 h-full flex transition-[width] duration-200 flex-col ${isOpen ? 'w-[260px] bg-surface md:bg-transparent inset-0' : 'w-[60px] hidden md:flex'}`}
      >
        <div
