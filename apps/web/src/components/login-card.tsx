    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background p-4 text-text-main relative overflow-hidden">
      ...
      >
        ...
        <div className="p-8 pb-6">
          ...
          <p className="text-text-muted text-sm leading-relaxed">Sign in to manage your webhooks and integrations.</p>
        </div>
        ...
        <div className="px-8 pb-8 space-y-5">
          ...
          <form className="space-y-4" onSubmit={(e) => handleLogin(e)}>
            ...
            <PasswordInput
              ...
              icon={Lock}
              trailing={
                <Link href="/auth/forgot-password" className="text-xs font-medium text-accent hover:text-primary transition-colors">Forgot password?</Link>
              }
            />
        ...
        <div className="border-t border-border px-8 py-5 text-center" style={{ borderBottomLeftRadius: '16px', borderBottomRightRadius: '12px' }}>
          <p className="text-sm text-text-muted">
            ...
            <Link href="/auth/sign-up" className="font-semibold hover:underline transition-colors" style={{ color: 'var(--primary)' }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
